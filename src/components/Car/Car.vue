      ...
      >
        <div class="py-6 px-4 md:px-6 xl:px-7.5 relative">
          ...
          >
            ...
            <div class="flex gap-5">
              <router-link
                  :to="{ name: 'AddCar' }"
                  class="inline-flex py-3 px-4 whitespace-nowrap text-white bg-primary rounded-xl hover:bg-primary-dark focus:outline-none text-sm font-semibold">Thêm ô tô
              </router-link>
        ...
        >
          ...
          <div class="col-span-2 flex items-center justify-center">
            <p class="font-bold">Địa điểm hiện tại </p>
          </div>
          ...
          <div class="col-span-2 md:col-span-3 flex items-center">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
              <div class="h-12.5 w-15 rounded-md">
                <img v-if="car.anh_xe" :alt="`Product: ${car.ten_xe}`" :src="car.anh_xe"/>
              </div>
