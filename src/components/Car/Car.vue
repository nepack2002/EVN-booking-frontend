        ...
        <div class="py-6 px-4 md:px-6 xl:px-7.5 relative">
          ...
          >
            ...
            <div class="flex gap-5">
              <router-link class="inline-flex py-3 px-4 whitespace-nowrap text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 focus:outline-none text-sm font-semibold" :to="{ name: 'AddCar' }">Thêm ô tô</router-link>
              <router-link :to="{ name: 'ImportCar' }" class="inline-flex py-3 px-4 whitespace-nowrap text-white bg-indigo-600 rounded-xl hover:bg-indigo-700 focus:outline-none text-sm font-semibold tracking-wide"
                ><svg
